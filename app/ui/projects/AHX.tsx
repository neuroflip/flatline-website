...
function AHX () {
  return <Project linkUrl="http://ahxmidiplayer.hopto.org/" 
    ...
    image="/projectAHX.webp">
    <>
      <div className='p-5'>
        <IconLink imageClassName='float-left m-4 w-8 h-8' url="https://github.com/neuroflip/AhxMidiPlayer" iconImage="/logoGithub.webp" iconAlt='github logo'></IconLink>
